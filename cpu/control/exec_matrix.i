...
if (pla[45]) begin
    ...
    if (M1 && T3) begin                       end
    if (M1 && T4) begin             contM1=1; end
    if (M2 && T1) begin             nextM=1; setM1cc=1; end
    if (M3 && T1) begin fMRead=1;             end
    if (M3 && T2) begin fMRead=1;             end
    if (M3 && T3) begin fMRead=1;             end
    if (M3 && T4) begin fMRead=1;             end
    if (M3 && T5) begin fMRead=1;             end
    if (M3 && T6) begin fMRead=1;   nextM=1; setM1=1;  end
end
...
if (pla[26]) begin
    ...
    if (M3 && T1) begin fMRead=1;             end
    if (M3 && T2) begin fMRead=1;             end
    if (M3 && T3) begin fMRead=1;   nextM=1; setM1bz=1; end
    if (M4 && T1) begin                       end
    if (M4 && T2) begin                       end
    if (M4 && T3) begin                       end
    if (M4 && T4) begin                       end
...
// PLA14 is set for decrement and reset for increment. Route that line for SBC/ADC ALU operation to perform a decrement or increment. Since the timings are the same, we use a single PLA entry for both functions.
    ...
    if (M1 && T4) begin             contM1=1; end
    if (M2 && T1) begin                       end
    if (M2 && T2) begin             nextM=1; setM1=1;  end
end
...
if (pla[83]) begin
    ...
    if (M1 && T3) begin                       end
    if (M1 && T4) begin             contM1=1; end
    if (M2 && T1) begin             nextM=1; setM1=1;  end
end
...
if (pla[21]) begin
    ...
    if (M1 && T4) begin             contM1=1; end
    if (M2 && T1) begin                       end
    if (M2 && T2) begin             nextM=1;  end
    if (M3 && T1) begin                       end
    if (M3 && T2) begin                       end
    if (M3 && T3) begin             nextM=1;  end
    if (M4 && T1) begin fMWrite=1;            end
    if (M4 && T2) begin fMWrite=1;            end
    if (M4 && T3) begin fMWrite=1;  nextM=1; setM1=1;  end
end
...
if (pla[20]) begin
    ...
    if (M4 && T2) begin                       end
    if (M4 && T3) begin                       end
    if (M4 && T4) begin             nextM=1; setM1=1;  end
end
