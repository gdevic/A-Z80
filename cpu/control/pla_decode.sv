...
begin
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX11100000000)  pla[107]=1'b1; else pla[107]=1'b0;   // 00000000  reserved2
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX11100000000)  pla[106]=1'b1; else pla[106]=1'b0;   // 00000000  reserved1
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'bXXXXXXXX1XXXX)  pla[101]=1'b1; else pla[101]=1'b0;   // xxx1xxxx  bit[4]
    if ({prefix[4:0], ir[7:0]} ==? 13'bXXXXXXXXX1XXX)  pla[100]=1'b1; else pla[100]=1'b0;   // xxxx1xxx  bit[3]
    if ({prefix[4:0], ir[7:0]} ==? 13'bXXXXXXXXXXXX1)  pla[ 99]=1'b1; else pla[ 99]=1'b0;   // xxxxxxx1  bit[0]
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX01110XXX)  pla[ 59]=1'b1; else pla[ 59]=1'b0;   // 01110xxx  ld (hl),r
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX01XXX110)  pla[ 58]=1'b1; else pla[ 58]=1'b0;   // 01xxx110  ld r,(hl)
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'bXXX1XXXXXX110)  pla[ 55]=1'b1; else pla[ 55]=1'b0;   // xxxxx110  cb: op (hl)
    if ({prefix[4:0], ir[7:0]} ==? 13'bX1X1XXXXXXXXX)  pla[ 54]=1'b1; else pla[ 54]=1'b0;   // xxxxxxxx  Every CB with IX/IY
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX0011010X)  pla[ 53]=1'b1; else pla[ 53]=1'b0;   // 0011010x  inc/dec (hl)
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX10XXX110)  pla[ 52]=1'b1; else pla[ 52]=1'b0;   // 10xxx110  add/sub/and/or/xor/cp (hl)
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX11101101)  pla[ 51]=1'b1; else pla[ 51]=1'b0;   // 11101101  ED
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX00110110)  pla[ 50]=1'b1; else pla[ 50]=1'b0;   // 00110110  ld (hl),n
    if ({prefix[4:0], ir[7:0]} ==? 13'bX1XXX11001011)  pla[ 49]=1'b1; else pla[ 49]=1'b0;   // 11001011  IX/IY + CB
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'bXX1XX11001011)  pla[ 44]=1'b1; else pla[ 44]=1'b0;   // 11001011  CB regular
    ...
    if ({prefix[4:0], ir[7:0]} ==? 13'b1XXXX11001011)  pla[ 22]=1'b1; else pla[ 22]=1'b0;   // 11001011  CB without IX/IY
