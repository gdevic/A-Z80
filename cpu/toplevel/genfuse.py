...
def RegWrite(reg, hex):
    ...
    ftest.write("#1 release dut.reg_file_.b2v_latch_" + reg + "_lo.we;\n")
...
while True:
    ...
    ftest.write("#1 release dut.instruction_reg_.ctl_ir_we;\n")
    ...
    ftest.write("#2 force dut.reg_file_.reg_gp_we=0;\n")
    ftest.write("   force dut.z80_top_ifc_n.fpga_reset=1;\n")
