...
add wave -noupdate -radix hexadecimal -childformat {{{/test_top/z80/D[7]} -radix hexadecimal} {{/test_top/z80/D[6]} -radix hexadecimal} {{/test_top/z80/D[5]} -radix hexadecimal} {{/test_top/z80/D[4]} -radix hexadecimal} {{/test_top/z80/D[3]} -radix hexadecimal} {{/test_top/z80/D[2]} -radix hexadecimal} {{/test_top/z80/D[1]} -radix hexadecimal} {{/test_top/z80/D[0]} -radix hexadecimal}} -subitemconfig {{/test_top/z80/D[7]} {-radix hexadecimal} {/test_top/z80/D[6]} {-radix hexadecimal} {/test_top/z80/D[5]} {-radix hexadecimal} {/test_top/z80/D[4]} {-radix hexadecimal} {/test_top/z80/D[3]} {-radix hexadecimal} {/test_top/z80/D[2]} {-radix hexadecimal} {/test_top/z80/D[1]} {-radix hexadecimal} {/test_top/z80/D[0]} {-radix hexadecimal}} /test_top/z80/D
