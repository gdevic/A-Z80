...
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/clk
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/nextM
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/setM1
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/hold_clk
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/reset
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T2_en
...
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/M6
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T1
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T2
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T3
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T4
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T5
add wave -noupdate -expand -group sequencer /test_top/dut/sequencer/T6
...
add wave -noupdate -expand -group {data pins} /test_top/dut/data_pins/ctl_bus_db_oe
add wave -noupdate -expand -group {data pins} /test_top/dut/data_pins/bus_db_we
...
add wave -noupdate -expand -group IR -expand -group PLA /test_top/dut/pla_decode/prefix
add wave -noupdate -expand -group IR -expand -group PLA -radix hexadecimal /test_top/dut/pla_decode/opcode
add wave -noupdate -expand -group IR -expand -group PLA /test_top/dut/pla_decode/pla
add wave -noupdate -expand -group IR -expand -group function /test_top/dut/pin_control/fFetch
add wave -noupdate -expand -group IR -expand -group function /test_top/dut/pin_control/fMRead
add wave -noupdate -expand -group IR -expand -group function /test_top/dut/pin_control/fMWrite
add wave -noupdate -expand -group IR -expand -group function /test_top/dut/pin_control/fIORead
add wave -noupdate -expand -group IR -expand -group function /test_top/dut/pin_control/fIOWrite
...
WaveRestoreCursors {{Cursor 1} {400 ps} 0} {{Cursor 2} {1600 ps} 0}
